...
enum Fixtures {
    ...
    static let index = IngredientIndex(facts: [
        ...
        facts("Paneer", aliases: ["cottage cheese"], category: .dairy, dairy: true,
              nutritionTags: ["protein", "calcium"]),
        facts("Milk", category: .dairy, unit: .millilitre, dairy: true, nutritionTags: ["calcium"]),
        facts("Egg", category: .egg, unit: .count, egg: true, nutritionTags: ["protein"]),
        facts("Cashews", category: .nutSeed, nuts: true, nutritionTags: ["healthyFat"]),
        facts("Whole wheat pasta", category: .grain, gluten: true, nutritionTags: ["grain", "wholeGrain"]),
